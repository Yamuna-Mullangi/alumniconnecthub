    ...
    <section className="py-20 px-6 md:px-12 bg-gradient-to-b from-muted/30 to-background">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <Card className="inline-block overflow-hidden border-2 border-primary/20">
            <CardContent className="p-8">
              <Calendar className="w-12 h-12 text-primary mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Can't Find Your Batch?</h3>
              <p className="text-muted-foreground mb-6 max-w-md">
                Register now to connect with your classmates and be part of our growing alumni network
              </p>
